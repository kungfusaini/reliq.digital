  ...
  if(canvas != null){
    ...
    xhr.onreadystatechange = function() {
      if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        // Allow multiple instances - don't set global flag
...
// Remove global auto-init to allow multiple instances
// Call window.particleImageDisplay("particle-id") manually for each canvas